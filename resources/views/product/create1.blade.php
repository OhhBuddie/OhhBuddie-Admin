...
<body>
    ...
    <div class="main-container d-flex">
        ...
        <div class="left-column">
            <form action="{{ route('products.store1' ) }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="select2-3 form-select" name="seller_table_id" style="width: 100%" onchange="sellerSelect(this)">
                                ...
                                @foreach($seller_data as $sld)
                                    <option value="{{ $sld->id }}">{{ $sld->owner_name }}</option>
                                @endforeach 
                            </select>
                        </div>
...
<!--Hidden input for ID -->
    ...
    document.querySelectorAll(`
            ...
            .Plazos, .Hot, .Cargos, .footware, .Kids`).forEach((div, index) => { // Use index to make IDs unique
