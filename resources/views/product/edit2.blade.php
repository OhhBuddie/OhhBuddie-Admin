...
<body>
    ...
    <div class="main-container d-flex">
        ...
        <div class="left-column">
            <form action="{{ route('product.update2',$product->id ) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
               ...
               <!--For Sarees -->
                ...
                <div class="card tshirt" style="display:none;">
                    ...
                    <div class="row g-3">            
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="sleeve_style1" placeholder="Enter Sleeve Style" value="{{$product->sleeve_style}}">
                        </div>
                        <div class="col-md-4">
                ...
                <div class="card shirt"  style="display:none;">
                    ...
                    <div class="row g-3">            
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Sleeve Style</label>
                            <input type="text" class="form-control" name="sleeve_style2" placeholder="Enter Sleeve Style" value="{{$product->sleeve_style}}">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Closure Type</label>
                            <!--<input type="text" class="form-control" name="closure_type" placeholder="Enter Closure Type">-->
                ...
                <div class="card Kids" style="display:none;">
                    ...
                    <div class="row g-3">          
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Fabric</label>
                            <select name="fabric22" class="form-control select2" >    
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control select2 size_select" name="size{{$mult['id']}}" style="width:100%">
                                                <option value="{{$mult['size']}}" selected>{{$mult['size']}}</option>
                                                @foreach($size as $sz)
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control quantity_input" name="quantity{{$mult['id']}}" placeholder="Enter Quantity" value="{{$mult['quantity']}}">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">SKU</label>
                                            <input type="text" class="form-control" name="sku{{$mult['id']}}" placeholder="Enter SKU Code" value="{{$mult['sku']}}">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Maximum Retail Price</label>
                                            <input type="number" class="form-control" name="maximum_retail_price{{$mult['id']}}" placeholder="Enter Maximum Retail Price" value="{{$mult['mrp']}}">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Bank Settlement Price</label>
                                            <input type="number" class="form-control" name="bank_settlement_price{{$mult['id']}}" placeholder="Enter Bank Settlement Price" value="{{$mult['bsp']}}">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Portal Updated Price</label>
                                            <input type="number" class="form-control" name="portal_updated_price{{$mult['id']}}" placeholder="Enter Portal Updated Price" value="{{$mult['portal_updated_price']}}" readonly>
                                        </div>
                                    </div>
                                </div>
                ...
                @endforeach
                                ...
                                <input type="hidden" class="form-control quantity_input" name="quantity" placeholder="Enter Quantity" oninput="updateHiddenInput()">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control select2" name="listing_status">
                                <option value="{{$product->listing_status}}">{{$product->listing_status}}</option>
        ...
        <div class="right-column" style="height:20px;">
            ...
            <div class="card">
                ...
                <div class="upload-box">
                    ...
                    <input type="hidden" value="{{$product->images}}">
                    <input type="hidden" id="rmvimg" name="rmvimg" value="">
             ...
             <script>
                ...
                function updatePreviews() {
                 ...
                 let removedImages = []; // Declare this outside, globally within the DOMContentLoaded function
                ...
                removeButton.onclick = function() {
                    ...
                    // Track removed image path
                    removedImages.push(imagePath);
                
                    // Update input value with removed images array
                    const removedInput = document.querySelector('#rmvimg');
                    if (removedInput) {
    ...
    document.querySelectorAll(`
            ...
            .Plazos, .Hot, .Cargos, .footware`).forEach((div, index) => { // Use index to make IDs unique
    ...
    <script>
        ...
        function updateHiddenInput() {
            ...
            allCards.forEach(card => {
                let size = card.querySelector('.size_select')?.value || '';
                let quantity = card.querySelector('.quantity_input')?.value || '';
                let sku = card.querySelector('input[name^="sku"]')?.value || '';
                let mrp = card.querySelector('input[name^="maximum_retail_price"]')?.value || '';
                let bsp = card.querySelector('input[name^="bank_settlement_price"]')?.value || '';
                let pup = card.querySelector('input[name^="portal_updated_price"]')?.value || '';
            ...
            document.querySelector('#size_quantity_data').value = JSON.stringify(combinedData);
        }      
        ...
        function create_card() {
            ...
            newCard.classList.add("card","cards", "mt-3");
...
<!--// Price Calculation-->
    ...
    document.addEventListener("input", function (e) {
        // Only process inputs that match our pattern
        if (e.target.name && e.target.name.startsWith("bank_settlement_price")) {
            let inputName = e.target.name; // e.g., bank_settlement_price123
            let id = inputName.replace("bank_settlement_price", ""); // get 123
            let bankSettlementPrice = parseFloat(e.target.value) || 0;

            let shipping = 0, bankprice = 0;
            let gurantee = 35;
            let inward = 9;
            ...
            if (shippingMode === "In-Store") {
                if (bankSettlementPrice >= 1 && bankSettlementPrice <= 400) {
                    shipping = 131;
                    bankprice = Math.round(
                        bankSettlementPrice +
                        shipping +
                        (0.05 * bankSettlementPrice) +
                        (0.03 * (bankSettlementPrice + shipping + (0.05 * bankSettlementPrice)))
                    );
                } else if (bankSettlementPrice <= 749) {
                    shipping = 180;
                    let base = bankSettlementPrice + shipping;
                    let ten = 0.1 * base;
                    bankprice = Math.round(base + ten + (0.03 * (base + ten)));
                } else if (bankSettlementPrice <= 1499) {
                    shipping = 200;
                    let base = bankSettlementPrice + shipping;
                    let fifteen = 0.15 * base;
                    bankprice = Math.round(base + fifteen + (0.03 * (base + fifteen)));
                } else if (bankSettlementPrice <= 2499) {
                    shipping = 220;
                    let base = bankSettlementPrice + shipping;
                    let eighteen = 0.18 * base;
                    bankprice = Math.round(base + eighteen + (0.03 * (base + eighteen)));
                } else {
                    shipping = 240;
                    let base = bankSettlementPrice + shipping;
                    let twenty = 0.2 * base;
                    bankprice = Math.round(base + twenty + (0.03 * (base + twenty)));
                }
                ...
                if (bankSettlementPrice >= 1 && bankSettlementPrice <= 400) {
                    ...
                    shipping = 180;
                    let base = bankSettlementPrice + shipping + gurantee + inward;
                    let ten = 0.1 * (bankSettlementPrice + shipping);
                    bankprice = Math.round(base + ten + (0.03 * (base + ten)));
                } else if (bankSettlementPrice <= 1499) {
                    shipping = 200;
                    let base = bankSettlementPrice + shipping + gurantee + inward;
                    let fifteen = 0.15 * (bankSettlementPrice + shipping);
                    bankprice = Math.round(base + fifteen + (0.03 * (base + fifteen)));
                } else if (bankSettlementPrice <= 2499) {
                    shipping = 220;
                    let base = bankSettlementPrice + shipping + gurantee + inward;
                    let eighteen = 0.18 * (bankSettlementPrice + shipping);
                    bankprice = Math.round(base + eighteen + (0.03 * (base + eighteen)));
                } else {
                    shipping = 240;
                    let base = bankSettlementPrice + shipping + gurantee + inward;
                    let twenty = 0.2 * (bankSettlementPrice + shipping);
                    bankprice = Math.round(base + twenty + (0.03 * (base + twenty)));
                }
            }

            // Update corresponding portal_updated_price field
            let portalField = document.getElementsByName("portal_updated_price" + id)[0];
            if (portalField) {
                portalField.value = bankprice;
            }
        }
    });
</script>
